...
import com.m1zark.pixelmoncommands.UI.CheckPartyUI;
...
public class CheckParty implements CommandExecutor {
    @Override
    public CommandResult execute(CommandSource src, CommandContext args) throws CommandException {
        ...
        ((Player) src).openInventory((new CheckPartyUI((Player) src)).getInventory());
